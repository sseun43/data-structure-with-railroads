...
bool MainProgram::add_random_stations_regions(Stopwatch &stopwatch, unsigned int size)
{
    ...
    // add n departures to random stations with random time
...
MainProgram::CmdResult MainProgram::cmd_random_stations(ostream& output, MatchIter begin, MatchIter end)
{
    ...
    Stopwatch dummy;
    add_random_stations_regions(dummy, size);
...
bool MainProgram::test_random_stations(Stopwatch &stopwatch)
{
    ...
    return add_random_stations_regions(stopwatch,1);
}
    ...
    try {
        ...
        for (unsigned int n : init_ns)
        {
            ...
            for (unsigned int i = 0; i < n / 1000; ++i)
            {
                ...
                add_random_stations_regions(stopwatch,1000);
            ...
            {
                // TODO check return value
                add_random_stations_regions(stopwatch,n % 1000);
            }
